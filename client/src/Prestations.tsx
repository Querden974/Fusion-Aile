...
export default function Prestations():ReactElement {
    ...
    return (
        <>
            <motion.div className={'grid mt-32 w-full mx-auto h-fit '}
                        initial={{opacity : 0, transform: 'translateY(20%)'}}
                        animate={{opacity : 1, transform: 'translateY(0%)'}}
                        exit={{opacity : 0, transform: 'translateY(20%)', transition : {duration: 0.1}}}>
                <div className={"flex flex-col gap-3 mx-auto bg-cover bg-[center_top_-5rem] w-168 h-[400px] bg-[url(./prestation-caline.webp)]"}>
                ...
                <Drawer styleBtn={'btn bg-primary hover:bg-primary-hover mx-auto w-fit text-white font-bold'}
